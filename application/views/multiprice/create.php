<div class="card">
    <div class="card-header">Tambah Multiprice Baru</div>
    <form action="" method="POST">
        <div class="card-body">
            <div class="form-group d-flex">
                <div class="col-sm-2">Kode Barang</div>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="BARANG_ID" id="BARANG_ID" value="<?= set_value('BARANG_ID') ?>">
            ...
            <div class="form-group d-flex">
                <div class="col-sm-2">Harga Per Item</div>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="" id="">
                    <small class=" form-text text-danger"><?= form_error(''); ?></small>
                </div>
